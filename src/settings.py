...
max_downloads_per_ip = 1000 # ips with more downloads will be ignored, as they cause the majority of the work and probably don't represent an individual person
